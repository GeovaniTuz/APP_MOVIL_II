    ...
    <div data-role="header" data-theme="a" data-position="fixed"><!-- encabezado de pagina -->
        ...
        <ul data-role="listview" data-dividertheme="a">
                ...
                ?>
                    ...
                    <h3><?php echo utf8_encode($fila_restaurantes[3]); ?></h3>
                    <p><?php echo utf8_encode($fila_restaurantes[4]); ?></p>
                    <p><?php echo utf8_encode($fila_restaurantes[5]); ?></p>
                    <p><?php echo utf8_encode($fila_restaurantes[6]); ?></p>
                </li>
