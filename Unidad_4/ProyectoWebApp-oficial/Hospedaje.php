    ...
    <div data-role="header" data-theme="a" data-position="fixed"><!-- encabezado de pagina -->
        ...
        <ul data-role="listview" data-dividertheme="a">
                ...
                <!-- id = 0 titulo = 1, img = 2, foto = 3 direccion = 4 etiquetas = 5 telefono = 6 -->
                    ...
                    <h3><?php echo utf8_encode($fila_hospedaje[1]); ?></h3>
                    <p><?php echo utf8_encode($fila_hospedaje[4]); ?></p>
                    <p><?php echo utf8_encode($fila_hospedaje[5]); ?></p>
                    <p><?php echo utf8_encode($fila_hospedaje[6]); ?></p>
                </li>
